    ...
    <header class="bg-white shadow-md">
      <nav class="container mx-auto px-4 py-4">
        <div class="flex justify-between items-center">
          <a routerLink="/" class="text-2xl font-bold text-gray-800">AnyturaPhoto</a>
          <ul class="flex space-x-6">
            ...
            <li><a routerLink="/work" routerLinkActive="text-blue-600" class="hover:text-blue-600 transition-colors">Work</a></li>
